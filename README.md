...
<table>
  <tr>
    <td width="50%">
      ...
      <p align="center"><sub>游戏库：首页支持封面、排序、状态标记与快速添加</sub></p>
    </td>
    <td width="50%">
      <img src="docs/readme/game-detail-install.png" alt="游戏详情与安装" width="100%">
      <p align="center"><sub>游戏详情：集中查看信息、安装状态与一键安装入口</sub></p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <img src="docs/readme/ai-translation.png" alt="AI 翻译页" width="100%">
      <p align="center"><sub>AI 翻译：查看状态、调节策略、切换云端 / 本地模式</sub></p>
    </td>
    <td width="50%">
      <img src="docs/readme/asset-pretranslation.png" alt="资产提取与预翻译" width="100%">
      <p align="center"><sub>资产提取与预翻译：提取文本、设置多轮翻译与缓存策略</sub></p>
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <img src="docs/readme/font-replacement.png" alt="字体替换" width="100%">
      <p align="center"><sub>字体替换：管理 TMP / TTF 替换源，处理缺字和乱码问题</sub></p>
    </td>
  </tr>
</table>
