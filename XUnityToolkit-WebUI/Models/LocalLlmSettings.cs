...
public static class BuiltInModelCatalog
{
    ...
    [
        ...
        new("sakura-14b-q4",
            "Sakura 14B Q4_K_M",
            "SakuraLLM 经典 ACGN 翻译模型，基于 Qwen2.5，14B 参数，适合 10-12GB 显存",
            (long)(8.99 * 1024 * 1024 * 1024),
            10,
            "SakuraLLM/Sakura-14B-Qwen2.5-v1.0-GGUF",
            "sakura-14b-qwen2.5-v1.0-q4km.gguf",
            ["ACGN", "日→中", "经典"]),

        new("sakura-7b-iq4",
            "Sakura 7B IQ4_XS",
            "SakuraLLM 轻量版，基于 Qwen2.5，7B 参数，适合 6-8GB 显存",
            (long)(4.25 * 1024 * 1024 * 1024),
            6,
