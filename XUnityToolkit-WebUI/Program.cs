...
builder.Services.AddSingleton<ToolboxAgentEndpointResolver>();
builder.Services.AddSingleton<ToolboxAgentAttachmentStore>();
builder.Services.AddSingleton<ToolboxAgentConversationStore>();
builder.Services.AddSingleton<ToolboxAgentHostAccessService>();
builder.Services.AddSingleton<ToolboxDataResetService>();
