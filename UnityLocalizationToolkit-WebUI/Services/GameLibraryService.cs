...
public sealed class GameLibraryService(AppDataPaths paths, ILogger<GameLibraryService> logger)
{
    ...
    private static Game CloneGame(Game game)
    {
        return new Game
        {
            ...
            XUnityStatus = new GameTranslationWorkspaceSummary
            {
                Workspace = game.XUnityStatus.Workspace,
                State = game.XUnityStatus.State,
                Available = game.XUnityStatus.Available,
                Active = game.XUnityStatus.Active,
                AssetCount = game.XUnityStatus.AssetCount,
                EditableAssetCount = game.XUnityStatus.EditableAssetCount,
                OverrideCount = game.XUnityStatus.OverrideCount,
                UpdatedAt = game.XUnityStatus.UpdatedAt,
                Summary = game.XUnityStatus.Summary
            },
            ManualTranslationStatus = new GameTranslationWorkspaceSummary
            {
                Workspace = game.ManualTranslationStatus.Workspace,
                State = game.ManualTranslationStatus.State,
                Available = game.ManualTranslationStatus.Available,
                Active = game.ManualTranslationStatus.Active,
                AssetCount = game.ManualTranslationStatus.AssetCount,
                EditableAssetCount = game.ManualTranslationStatus.EditableAssetCount,
                OverrideCount = game.ManualTranslationStatus.OverrideCount,
                UpdatedAt = game.ManualTranslationStatus.UpdatedAt,
                Summary = game.ManualTranslationStatus.Summary
            }
        };
    }
}
