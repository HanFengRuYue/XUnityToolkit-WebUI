...
internal sealed class FileLoggerProvider : ILoggerProvider
{
    ...
    public FileLoggerProvider(string logsDirectory, LogLevel minLevel = LogLevel.Information)
    {
        ...
        _filePath = Path.Combine(logsDirectory, $"UnityLocalizationToolkit_{_sessionTimestamp}.log");
    ...
    private void CleanupOldLogFiles()
    {
        try
        {
            var logFiles = Directory.GetFiles(_logsDirectory, "UnityLocalizationToolkit_*.log")
