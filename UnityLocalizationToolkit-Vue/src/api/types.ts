...
export interface Game {
  ...
  xUnityStatus: GameTranslationWorkspaceSummary
  manualTranslationStatus: GameTranslationWorkspaceSummary
}

export type GameTranslationWorkspace = 'XUnity' | 'Manual'

export interface GameTranslationWorkspaceSummary {
  workspace: GameTranslationWorkspace
  state: string
  available: boolean
  active: boolean
  assetCount: number
...
export type ManualTranslationAssetStorageKind =
  | 'LooseAssetFile'
  | 'BundleEntry'
  | 'ManagedAssembly'
  | 'ManagedResource'
...
export interface ManualTranslationAssetEntry {
  assetId: string
  storageKind: ManualTranslationAssetStorageKind
  valueKind: ManualTranslationAssetValueKind
  objectType: string
  assetFile: string
  bundleEntry?: string
  relativePath?: string
...
export interface ManualTranslationProjectIndex {
  gameId: string
  scannedAt: string
  assets: ManualTranslationAssetEntry[]
}

export interface ManualTranslationStatus {
  gameId: string
  hasScan: boolean
  state: string
  assetCount: number
...
export interface ManualTranslationApplyResult {
